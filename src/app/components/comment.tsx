        ...
        <div className={styles.commentContent}>
          <header>
            <div className={styles.authorAndTime}>
              ...
              <time title='28 de junho às 00:44' dateTime='2024-06-28 00:44:55'>Cerca de 1h atrás</time>
            </div>
